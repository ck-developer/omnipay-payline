...
class DirectGatewayTest extends GatewayTestCase
{
    ...
    public function testEndpoint()
    {
        ...
        $this->assertSame('http://www.payline.com/wsdl/v4_0/production/DirectPaymentAPI.wsdl', $this->gateway->getEndpoint());

        $this->gateway->setTestMode(true);
        $this->assertSame('http://www.payline.com/wsdl/v4_0/homologation/DirectPaymentAPI.wsdl', $this->gateway->getEndpoint());
    }
